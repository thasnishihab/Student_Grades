...
# SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'django-insecure-jpvi=+uyt%5$#91+tzyy#q%alnp8wq2at!6^@q8%k*33g-$=4w'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = False

# ALLOWED_HOSTS = ['your_domain.com', 'your_droplet_ip', 'localhost']
...
MIDDLEWARE = [
    ...
    # 'grades.middleware.AuthenticationMiddleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'grades' / 'templates' / 'admin',
            BASE_DIR / 'grades' / 'templates' / 'grades',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
